...
from utils.torch_utils import select_device, smart_inference_mode, ModelEMA
...
def run(
    ...
    output_path = f"{weights[0].split('.pt')[0]}_prune_{sparsity}.pt"
...
def parse_opt():
    ...
    parser.add_argument("--sparsity", type=float, default=0.3, help="desired sparsity for the saved model")
